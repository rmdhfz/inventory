...
<head>
  ...
  <title>Inventory Appllication</title>
...
<body id="body">
  <section class="w3l-workinghny-form">
    ...
    <div class="copyright text-center">
      <div class="wrapper">
        <p class="copy-footer-29">© 2021 <a href="<?php echo site_url() ?>">Inventory Application</a>. All rights reserved | Design by <a rel="noreferrer nofollow" href="https://linkedin.com/in/hfzrmd" target="_blank">Hafiz Ramadhan</a></p>
      </div>
    </div>
  </section>
</body>
