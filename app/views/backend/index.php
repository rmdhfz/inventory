...
<html lang="id">
    ...
    <head>
        ...
        <title>Dashboard &bull; Inventory Application</title>
                ...
                <div class="navbar-wrapper">
                    <div class="navbar-logo">
                        <a href="<?php echo site_url() ?>" style="font-weight: bold;">
                            <strong><b>Inventory Application</b></strong>
                        </a>
                        ...
                        <ul class="nav-right">
                            <li>
                                <small style="font-weight: bold; text-transform: uppercase;">
                                    Hai, <?php echo session('user_name');?> - <?php echo salam(); echo (session('is_admin') ? " (Admin)" : " (Employee)") ?>
                                </small>
                            </li>
                    ...
                    <div class="pcoded-content">
                        <div class="pcoded-inner-content">
                            ...
                            <center>  
                              ...
                              <br> 
                              <small> &copy; 2022 Inventory Application </small>
                            </center> <br>
                        </div>
                    </div>
